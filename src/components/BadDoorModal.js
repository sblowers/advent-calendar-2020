		...
		return (
			...
			>
				...
				<Modal.Body>
					...
					<p>{`Remain calm.`}</p>
					<p>{`If you think something has gone wrong and you should be able to open this door, or you just want to it now because you live on the wild side, then you can unlock the contents of this door in the main menu.`}</p>
				</Modal.Body>
