...
const sideAContents = (door_id) => {
	switch(door_id+1) {
		...
		case 2: 
			return(
					<div>
						<h5 style = {{marginTop: "10px"}}>Rockin' Around the Christmas Tree - Brenda Lee</h5>
						<p>
							<b>Did you know?: </b>{`Lee was 13 years old when this song was recorded!`}
						</p>
						<div style = {{width: "100%", textAlign: "center"}}>
							<iframe 
		...
		case 6: 
			return(
					<div>
						...
						<p>
							<b>Did you know?: </b>{`'Deck the Halls' has appeared in The Big Bang Theory, Nightmare before Christmas, The Office and Emma`}
						</p>
						<div style = {{width: "100%", textAlign: "center"}}>
							<iframe 
		...
		case 7: 
			return(
					<div>
						...
						<p>
							<b>Did you know?: </b>{`Tamar is Toni Braxton’s sister, she does not like being referred to as this however.`}
						</p>
						<div style = {{width: "100%", textAlign: "center"}}>
							<iframe 
								title= "Sleigh Ride" 
		...
		case 8: 
			return(
					<div>
						...
						<p>
							<b>Did you know?: </b>{`This song is now censored on BBC radio, a decision which has prompted huge outcry and discussion about artistic license.`}
						</p>
						<div style = {{width: "100%", textAlign: "center"}}>
							<iframe 
		...
		case 17: 
			return(
					<div>
						...
						<p>
							<b>Did you know?: </b>{`Slade make at least £500,000 a year from this song in royalties.`}
						</p>
						<div style = {{width: "100%", textAlign: "center"}}>
							<iframe 
		...
		case 18: 
			return(
					<div>
						...
						<p>
							<b>Did you know?: </b>{`Whitney Houston is the only artist to chart seven number one Billboard100 hits in a row. She is regarded as having had one of the most beautiful voices ever recorded. `}
						</p>
						<div style = {{width: "100%", textAlign: "center"}}>
							<iframe 
		...
		case 20: 
			return(
					<div>
						...
						<p>
							<b>Did you know?: </b>{`This was Dolly’s first Christmas song in 30 years.`}
						</p>
						<div style = {{width: "100%", textAlign: "center"}}>
							<iframe 
		...
		case 22: 
			return(
					<div>
						...
						<p>
							<b>Did you know?: </b>{`Frank Sinatra had vivid coloured eyes, earning him the nickname ‘old blue eyes’.`}
						</p>
						<div style = {{width: "100%", textAlign: "center"}}>
							<iframe 
								title= "First Noel" 
		...
		case 23: 
			return(
					<div>
						...
						<p>
							<b>Did you know?: </b>{`Rosemary Clooney, George Clooney’s aunt, is the taller actress next to Bing Crosby in the video.`}
						</p>
						<div style = {{width: "100%", textAlign: "center"}}>
							<iframe 
		...
		case 24: 
			return(
					<div>
						...
						<p>
							<b>Did you know?: </b>{`Originally written by drummer Roger May and gutarist Brian May, the song was released with no video. The cartoon was made in 2019 to accompany it.`}
						</p>
						<div style = {{width: "100%", textAlign: "center"}}>
							<iframe 
